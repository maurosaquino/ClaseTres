...
if (isset($_POST['p'])&&isset($_POST['u'])&&isset($_POST['p2'])){
...
<html >
  <head>
   	 		<meta charset="UTF-8">
   		 	<title>Programación III - Aplicación XXVII - Mauro Aquino</title>
  ...
  <body>
	...
	<form method="post">
        ...
        <input type="password" name="p2" placeholder="Confirmar contraseña" required="required" />
